...
#ifdef UESTEAMFRAMEWORK_FrameworkDef_generated_h
#error "FrameworkDef.generated.h already included, missing '#pragma once' in FrameworkDef.h"
#endif
...
#define CURRENT_FILE_ID SteamPlugin_Plugins_UESteamFramework_Source_UESteamFramework_Public_FrameworkDef_h


#define FOREACH_ENUM_ELOBBYPUBLICLEVEL(op) \
	op(ELobbyPublicLevel::PL_Private) \
	op(ELobbyPublicLevel::PL_FriendsOnly) 
#define FOREACH_ENUM_ELOBBYCREATION(op) \
	op(ELobbyCreation::LC_Success) \
	op(ELobbyCreation::LC_Failed) \
	op(ELobbyCreation::LC_Timeout) 
